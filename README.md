...
- `build` contains the final HTML with rendered nunjucks data and inlined CSS / -premailer styles: `boilerplate/src/build/index.html`. **Note:** This is the final HTML code you will copy and paste into your Gamma message.
